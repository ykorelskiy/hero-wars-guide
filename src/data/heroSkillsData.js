export const HERO_SKILLS_DB = {
  ...
  "adam": [
    {
      "desc": "Адам делает точный выстрел во вражеского героя без Метки Охотника, находящегося ближе всего к центру вражеской команды. Выстрел накладывает Метку Охотника и наносит физический урон. Если цель погибает под действием Метки Охотника, перезарядка умения мгновенно сбрасывается.",
      "name": "1 - Захват Цели (Bounty Lock)",
      "type": "Активное умение (Ультимативное)",
      "formula": "257,905 Физический урон",
      "name_en": "Bounty Lock",
      "icon_url": "/images/skills/adam_skill_1.webp",
      "priority": "Очень высокий — первое умение для прокачки, так как это главный источник урона и старта механики Метки Охотника.",
      "explanation": "Захват Цели — основной инструмент взрывного урона Адама и источник Метки Охотника. Метка питает пассивное умение Адаптивный Калибр, а мгновенный сброс при смерти цели позволяет накладывать метки цепной реакцией."
    },
    {
      "desc": "Адам быстро делает серию из 3 выстрелов по ближайшему врагу. Если на поле боя есть враги с Меткой Охотника, выстрелы рикошетят в них, нанося дополнительный урон.",
      "name": "2 - Веер Выстрелов (Fan the Hammer)",
      "type": "Активное умение",
      "formula": "78,990 Физический урон за выстрел (3 выстрела) + 46,045 Рикошетный урон; Перезарядка: 7 сек.",
      "name_en": "Fan the Hammer",
      "icon_url": "/images/skills/adam_skill_2.webp",
      "priority": "Высокий — второе умение для прокачки, расширяющее урон по нескольким меткам.",
      "explanation": "Веер Выстрелов добавляет урон по области. Выстрелы рикошетят по всем помеченным Меткой Охотника целям. Чем больше меток наложено через Захват Цели, тем больше врагов получают одновременный урон."
    },
    {
      "desc": "Пассивное умение. Когда Адам наносит физический урон и не пробивает броню цели полностью, его Пробивание Брони увеличивается. Если Адам полностью пробивает броню цели, вместо этого увеличивается его Физическая Атака. Оба эффекта суммируются и действуют до конца боя.",
      "name": "3 - Адаптивный Калибр (Adaptive Caliber)",
      "type": "Пассивное умение",
      "formula": "+3,533 Пробивание Брони (при неполном пробитии) или +4,707 Физическая Атака (при полном пробитии) за каждый стак",
      "name_en": "Adaptive Caliber",
      "icon_url": "/images/skills/adam_skill_3.webp",
      "priority": "Средне-высокий — третье для прокачки, так как повышает накапливаемый бонус Физической Атаки и Пробивания Брони.",
      "explanation": "Адаптивный Калибр — пассивный двигатель роста урона Адама. Если у цели есть броня, он накапливает пробивание брони; когда броня полностью пробита, накапливает чистую физическую атаку до конца боя."
    },
    {
      "desc": "Раз в 10 секунд при получении урона под Адамом на 5 секунд развертывается дымовая завеса. Находясь в дымовой завесе, Адам получает дополнительное уклонение и может уклоняться от всех типов урона, а не только от физического.",
      "name": "4 - Реактивный Экран (Reactive Screen)",
      "type": "Защитное умение",
      "formula": "+13,436 Уклонение на 5 сек; Перезарядка: 10 сек.",
      "name_en": "Reactive Screen",
      "icon_url": "/images/skills/adam_skill_4.webp",
      "priority": "Средний — прокачивается в последнюю очередь, так как защитные характеристики важны после развития урона.",
      "explanation": "Реактивный Экран — единственный защитный инструмент Адама. Активируется автоматически при получении урона, создавая дымовую завесу, повышающую уклонение от любого типа урона (включая магический)."
    }
  ],
  "somna": [
    {
