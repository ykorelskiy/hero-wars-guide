/* ======================================================================
   HERO WARS — TIER LIST DATABASE 2026 (alexandregames.com)
   ====================================================================== */
...
export const TIER_RANKS = {
  'S++': {
    ...
    border: '#f87171',
    desc: 'Абсолютные лидеры мета-игры 2026 года. Определяют стратегию боёв в Арене и Межсерверной Войне ГИ.'
  },
  'S+': {
